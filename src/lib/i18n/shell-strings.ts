const SHELL_STRINGS = {
  es: {
    ...
    homeNoIntegrationsTitle: 'No hay integraciones conectadas',
    homeNoIntegrationsDescription: 'Conecta una integración para empezar a ver tus datos.',
    homeNoIntegrationsCta: 'Ir a integraciones',
    homeOnboardingWelcome: 'Bienvenido a Alenna',
    homeOnboardingWelcomeNamed: 'Bienvenido, {name}',
    homeOnboardingHeadline: 'Tu inteligencia comercial empieza aquí',
    homeOnboardingSubheadline:
      'Conecta Shopify, Mercado Libre u otro canal de ventas y transforma tus datos en insights de margen, alertas de inventario y reportes de rentabilidad.',
    homeOnboardingPrimaryCta: 'Conectar mi primer canal',
    homeOnboardingJourneyConnect: 'Conectar',
    homeOnboardingJourneySync: 'Sincronizar',
    homeOnboardingJourneyAnalyze: 'Analizar',
    homeOnboardingChannelsTitle: 'Conecta tu primer canal',
    homeOnboardingPreviewEyebrow: 'Vista previa',
    homeOnboardingPreviewTitle: 'Así se verá tu centro de comando',
    homeOnboardingPreviewSales: 'Ventas por canal',
    homeOnboardingPreviewMargins: 'Márgenes',
    homeOnboardingPreviewInventory: 'Inventario',
    homeOnboardingPreviewReports: 'Reportes',
  ...
  en: {
    ...
    homeNoIntegrationsTitle: 'No integrations connected',
    homeNoIntegrationsDescription: 'Please connect an integration to start seeing your data.',
    homeNoIntegrationsCta: 'Go to integrations',
    homeOnboardingWelcome: 'Welcome to Alenna',
    homeOnboardingWelcomeNamed: 'Welcome, {name}',
    homeOnboardingHeadline: 'Your commerce intelligence starts here',
    homeOnboardingSubheadline:
      'Connect Shopify, Mercado Libre, or another sales channel and transform your data into margin insights, inventory alerts, and profitability reports.',
    homeOnboardingPrimaryCta: 'Connect my first channel',
    homeOnboardingJourneyConnect: 'Connect',
    homeOnboardingJourneySync: 'Sync',
    homeOnboardingJourneyAnalyze: 'Analyze',
    homeOnboardingChannelsTitle: 'Connect your first channel',
    homeOnboardingPreviewEyebrow: 'Preview',
    homeOnboardingPreviewTitle: 'This is what your command center will look like',
    homeOnboardingPreviewSales: 'Sales by channel',
    homeOnboardingPreviewMargins: 'Margins',
    homeOnboardingPreviewInventory: 'Inventory',
    homeOnboardingPreviewReports: 'Reports',
