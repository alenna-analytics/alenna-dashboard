const SHELL_STRINGS = {
  es: {
    ...
    teamInviteSheetDescription:
      'Envía una invitación y elige el acceso que tendrá la nueva persona en tu espacio de trabajo.',
    teamInviteEmailLabel: 'Correo electrónico',
    teamInviteEmailPlaceholder: 'nombre@ejemplo.com',
  ...
  en: {
    ...
    teamInviteEmailLabel: 'Email address',
    teamInviteEmailPlaceholder: 'name@example.com',
