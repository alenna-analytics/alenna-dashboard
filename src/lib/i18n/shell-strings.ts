const SHELL_STRINGS = {
  es: {
    ...
    productsDetailCobroShopifyNoTaxAlertBefore:
      'Shopify no retiene impuestos: no es marketplace, tú facturas directo al cliente final. Amazon y Mercado Libre actúan como intermediarios y enteran ISR e IVA al SAT a tu nombre. Las tasas son configurables en',
    productsDetailCobroShopifyNoTaxAlertAfter: '.',
  ...
  en: {
    ...
    productsDetailCobroShopifyNoTaxAlertBefore:
      'Shopify does not withhold tax: it is not a marketplace — you invoice the end customer directly. Amazon and Mercado Libre act as intermediaries and remit ISR and VAT to the tax authority on your behalf. Rates are configurable in',
    productsDetailCobroShopifyNoTaxAlertAfter: '.',
