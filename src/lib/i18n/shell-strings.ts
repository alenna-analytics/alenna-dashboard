const SHELL_STRINGS = {
  es: {
    ...
    permTaxRatesManage: 'Gestionar tasas de impuestos',
    permTaxRatesManageDesc: 'Configurar porcentajes de retenciones y traslado IVA.',
    permTaxRatesView: 'Ver tasas de impuestos',
    permTaxRatesViewDesc: 'Ver los porcentajes fiscales configurados del espacio.',
    ...
    workspaceConfigFxRatesDescription: 'Consulta tasas FX usadas para convertir a la moneda base.',
    workspaceConfigFxRatesSubtitle:
      'Tasas de mercado aplicadas a pedidos y gastos en monedas distintas a la base del espacio.',
    workspaceConfigFxRatesFiltersTitle: 'Filtros',
    workspaceConfigFxRatesListTitle: 'Historial de tasas',
    workspaceConfigFxRatesAutoHint: 'Se actualizan automáticamente. Solo lectura en esta versión.',
    workspaceConfigFxRatesChartTitle: 'Evolución del tipo de cambio',
    workspaceConfigFxRatesChartDescription: 'Serie diaria para {pair} en el rango seleccionado.',
    workspaceConfigFxRatesChartEmpty: 'No hay datos para graficar con los filtros actuales.',
    workspaceConfigFxRatesLoadFailed: 'No se pudieron cargar las tasas de cambio.',
    workspaceConfigFxRatesEmpty: 'Aún no hay tasas registradas.',
    workspaceConfigFxRatesColDate: 'Fecha',
    workspaceConfigFxRatesColPair: 'Par',
    workspaceConfigFxRatesColRate: 'Tasa',
    workspaceConfigFxRatesColSource: 'Fuente',
    ...
    settingsCurrencyDescription:
      'Moneda base del espacio de trabajo para reportes y costos. No se puede cambiar después de crear el espacio.',
    ...
    salesYoyChartCalcDescription: 'Compara ventas netas del periodo actual con el mismo rango del año previo.',
    salesYoyChartCalcLeft: 'YoY = ',
    salesYoyChartCalcFormula: 'ventas netas actuales vs año anterior',
    ...
    salesQualityHelpDiscountRate:
      'Porcentaje de las ventas brutas que se cede en descuentos del periodo. Un valor más bajo indica menos erosión del precio de lista.',
    salesQualityHelpDiscountRateCalcLeft: 'Tasa = ',
    salesQualityHelpDiscountRateCalcPart: 'descuentos ÷ ventas brutas',
    salesQualityReturnRate: 'Tasa de devoluciones',
    salesQualityHelpReturnRate:
      'Porcentaje de las ventas brutas perdido por devoluciones y cancelaciones del periodo.',
    salesQualityHelpReturnRateCalcLeft: 'Tasa = ',
    salesQualityHelpReturnRateCalcPart: 'devoluciones ÷ ventas brutas',
    salesQualityUnitsPerOrder: 'Unidades por pedido',
    salesQualityHelpUnitsPerOrder:
      'Promedio de unidades incluidas en cada pedido del periodo.',
    salesQualityHelpUnitsPerOrderCalcLeft: 'UPO = ',
    salesQualityHelpUnitsPerOrderCalcPart: 'unidades ÷ pedidos',
    salesSkuColumn: 'SKU',
    ...
    channelsPnlTitleByProduct: 'P&L por producto',
    ...
    channelsPnlSubtitleByProduct:
      'Rentabilidad Alenna por producto del grupo, con pedidos y AOV.',
    ...
    channelsCmChartCalcDescription: 'Contribución marginal en dinero por canal a lo largo del periodo.',
    channelsCmChartCalcLeft: 'CM$ = ',
    channelsCmChartCalcFormula: 'ventas netas − COGS − comisiones − envío − ads',
    channelsCostStructureCalcDescription:
      'Cómo se reparte cada peso de ventas netas entre COGS, comisiones, envío y contribución.',
    channelsCostStructureCalcLeft: 'Estructura = ',
    channelsCostStructureCalcFormula: '% de ventas netas por rubro',
    ...
    channelsPnlSubtitleProductScope:
      'La última línea refleja utilidad bruta aproximada: comisiones y envío de plataforma no se prorratean por producto.',
    ...
    reportsKpiHelpChannelMargin:
      'Economía real de vender en el canal: lo que queda de la utilidad bruta tras comisiones y envío.',
    reportsKpiHelpChannelMarginCalcLeft: 'Margen = ',
    reportsKpiHelpChannelMarginCalcPart: 'utilidad bruta − comisiones − envío',
    homeKpiRoasGlobal: 'ROAS global',
    homeKpiRoasGlobalHelp: 'Retorno de la inversión publicitaria en el periodo.',
    homeKpiRoasGlobalCalcLeft: 'ROAS = ',
    homeKpiRoasGlobalCalcPart: 'ventas atribuidas ÷ gasto en ads',
    ...
    homeAdsTrendCalcDescription: 'Gasto publicitario y ventas atribuidas en el periodo del filtro.',
    homeAdsTrendCalcLeft: 'Publicidad = ',
    homeAdsTrendCalcPartSpend: 'gasto en ads',
    homeAdsTrendCalcPartSales: 'ventas atribuidas',
    ...
    homeMetricsTrendCalcDescription:
      'Evolución de las métricas seleccionadas en el periodo del filtro.',
    homeMetricsTrendCalcLeft: 'Serie = ',
    homeMetricsTrendCalcPartNet: 'ventas netas',
    homeMetricsTrendCalcPartCm: 'contribución',
    homeMetricsTrendCalcPartUnits: 'unidades / pedidos',
    ...
    adsKpiHelpRoas: 'Retorno de ad spend. Vacío si el gasto es 0.',
    adsKpiHelpRoasCalcLeft: 'ROAS = ',
    adsKpiHelpRoasCalcPart: 'ventas atribuidas ÷ gasto',
    adsKpiHelpBreakEvenRoas:
      'ROAS mínimo para no perder margen bruto. Requiere COGS completo en ventas; si falta costo o el margen es ≤ 0, queda vacío.',
    adsKpiHelpBreakEvenRoasCalcLeft: 'ROAS eq. = ',
    adsKpiHelpBreakEvenRoasCalcPart: '1 ÷ margen bruto %',
    adsKpiHelpTacos:
      'Total Advertising Cost of Sales: qué porcentaje de las ventas netas del canal se va en ads. Vacío si no hay tienda vinculada (caso solo-ads).',
    adsKpiHelpTacosCalcLeft: 'TACoS = ',
    adsKpiHelpTacosCalcPart: 'gasto ads ÷ ventas netas',
    adsKpiHelpCpa:
      'Costo por adquisición: cuánto cuesta, en promedio, cada conversión atribuida. Vacío si no hay conversiones.',
    adsKpiHelpCpaCalcLeft: 'CPA = ',
    adsKpiHelpCpaCalcPart: 'gasto ÷ conversiones',
    ...
    adsChartTrendCalcDescription: 'Gasto publicitario y ventas atribuidas en el periodo del filtro.',
    adsChartTrendCalcLeft: 'Publicidad = ',
    adsChartTrendCalcPartSpend: 'gasto en ads',
    adsChartTrendCalcPartSales: 'ventas atribuidas',
    adsChartChannelCalcDescription: 'Participación de cada canal en el gasto publicitario del periodo.',
    adsChartChannelCalcLeft: 'Participación = ',
    adsChartChannelCalcFormula: 'gasto del canal ÷ gasto total en ads',
    ...
    adsSyncWaitingAmazonReport: 'Esperando el reporte de Amazon Ads…',
    adsSyncWaitingAmazonReportDetail:
      'Amazon está generando el reporte ({type}, {start}–{end}). Puede tardar varios minutos.',
    adsCampaignTypeSponsoredProducts: 'Sponsored Products',
    adsCampaignTypeSponsoredBrands: 'Sponsored Brands',
    adsCampaignTypeSponsoredDisplay: 'Sponsored Display',
    ...
    homeChannelDonutCalcDescription: 'Participación de cada canal sobre las ventas netas del periodo.',
    homeChannelDonutCalcLeft: 'Participación = ',
    homeChannelDonutCalcFormula: 'ventas netas del canal ÷ ventas netas totales',
    homeChannelDonutCalcPartNet: 'ventas netas del canal',
    homeChannelDonutCalcPartShare: 'ventas netas totales',
    ...
    homeTopProductsCalcDescription: 'Ranking de productos por ventas netas en el periodo.',
    homeTopProductsCalcLeft: 'Top productos = ',
    homeTopProductsCalcPartUnits: 'unidades vendidas',
    homeTopProductsCalcPartNet: 'ventas netas',
    ...
    reportsKpiHelpContributionMargin: 'Lo que queda para cubrir gastos fijos.',
    reportsKpiHelpContributionMarginCalcLeft: 'CM = ',
    reportsKpiHelpContributionMarginCalcPart: 'margen de canal − gasto en ads',
    reportsKpiHelpEbitda:
      'No incluye retenciones plataforma (esas afectan liquidez, no rentabilidad).',
    reportsKpiHelpEbitdaCalcLeft: 'EBITDA = ',
    reportsKpiHelpEbitdaCalcPart: 'contribución marginal − gastos operativos fijos',
    ...
    settlementCancelCostTitle: 'Cobro devuelto / Costos de cancelación',
    settlementCancelCostHint:
      'Cancelaciones MeLi con costo residual (envío + cargo por devolución). Ya está en el cobro neto; aquí se ve el desglose, no en Devoluciones del P&L de ventas.',
    settlementCancelCostSection: 'Cobro devuelto (MeLi)',
    settlementCancelCostMerchandise: 'Precio del producto',
    settlementCancelCostAnnulled: 'Anulación mercancía',
    settlementCancelCostFees: 'Comisiones netas',
    settlementCancelCostShipping: 'Envíos / cargo por devolución',
    settlementCancelCostTax: 'Retenciones netas',
    settlementCancelCostTotal: 'Total costo (neto MeLi)',
    ...
    reportsWaterfallCalcDescription:
      'Desglose del P&L: cada barra suma o resta desde ventas brutas hasta el resultado del periodo.',
    reportsWaterfallCalcLeft: 'EBITDA ≈ ',
    reportsWaterfallCalcPartGross: 'ventas brutas',
    reportsWaterfallCalcPartDeductions: '− deducciones',
    reportsWaterfallCalcPartCogs: '− COGS',
    reportsWaterfallCalcPartOpex: '− ads y gastos',
    reportsSettlementCalcDescription:
      'Estimación de lo que la plataforma liquida: ventas brutas menos descuentos, devoluciones, comisiones, envío y retenciones.',
    reportsSettlementCalcLeft: 'Cobro neto ≈ ',
    reportsSettlementCalcPartGross: 'ventas brutas',
    reportsSettlementCalcPartDeductions: '− descuentos/devoluciones',
    reportsSettlementCalcPartFees: '− comisiones y cargos',
    dashboardProfitMarginCalcDescription:
      'Utilidad bruta del periodo y su margen sobre ventas netas.',
    dashboardProfitMarginCalcLeft: 'Margen bruto % = ',
    dashboardProfitMarginCalcFormula: 'utilidad bruta ÷ ventas netas',
    ...
    reportsKpiAov: 'AOV',
    reportsKpiHelpAov:
      'Ticket promedio (Average Order Value): cuánto deja, en promedio, cada pedido del periodo.',
    reportsKpiHelpAovCalcLeft: 'AOV = ',
    reportsKpiHelpAovCalcPart: 'ventas ÷ pedidos',
    reportsKpiMomLabel: 'Crecimiento MoM %',
    reportsKpiHelpMom:
      'Crecimiento mes a mes (Month over Month) de las ventas netas respecto al mes calendario anterior.',
    reportsKpiHelpMomCalcLeft: 'MoM = ',
    reportsKpiHelpMomCalcPart: '(actual − mes anterior) ÷ mes anterior',
    reportsKpiYoyLabel: 'Crecimiento YoY %',
    reportsKpiHelpYoy:
      'Crecimiento año contra año (Year over Year) de las ventas netas respecto al mismo rango del año anterior.',
    reportsKpiHelpYoyCalcLeft: 'YoY = ',
    reportsKpiHelpYoyCalcPart: '(actual − año anterior) ÷ año anterior',
    ...
    reportsTaxBlockWithholdingIsr: 'Retención ISR',
    reportsTaxBlockWithholdingIva: 'Retención IVA',
    ...
    productsDetailTabPlatformPayment: 'Rentabilidad',
    productsDetailTabVariants: 'Variantes',
    productsDetailTabCogs: 'COGS',
    productsDetailTabRelated: 'Productos',
    productsCatalogTabProducts: 'Productos',
    productsCatalogTabGroups: 'Grupos',
    productsTableGroupSelected: 'Agrupar',
    productsTableGroupFailed: 'No se pudo agrupar la selección.',
    productsTableGroupNeedTwo: 'Selecciona al menos 2 productos para agrupar.',
    productsDetailChannelMargin: 'Margen de canal',
    productsDetailChannelMarginHelp:
      'Economía real de vender en el canal: lo que queda de la utilidad bruta tras comisiones y envío de plataforma.',
    productsDetailChannelMarginHelpCalcLeft: 'Margen = ',
    productsDetailChannelMarginHelpCalcPart: 'utilidad bruta − comisiones − envío',
    productsDetailCmPerUnit: 'CM / unidad',
    productsDetailAvgPrice: 'Precio promedio',
    productsDetailUnitCogs: 'COGS unitario',
    productsDetailAdsAssigned: 'Ads asignados',
    productsDetailChannelPnlTitle: 'P&L por canal',
    productsDetailInventoryByChannelTitle: 'Inventario por canal',
    ...
    productsVinculacionKindLinked: 'Vinculado',
    productsVinculacionColMatchType: 'Tipo de coincidencia',
    ...
    productsVinculacionPickerSelectedEmpty: 'Selecciona productos para vincular (puede haber varios del mismo canal).',
    ...
    productsVinculacionDangerSubtitle:
      'Acciones permanentes sobre este grupo de vinculación. No se pueden deshacer.',
    productsVinculacionDangerCardTitle: 'Eliminar grupo',
    ...
    productsVinculacionRename: 'Renombrar',
    productsVinculacionMoreActions: 'Más acciones',
    productsVinculacionPickerAddTitle: 'Agregar al grupo',
    productsVinculacionPickerAddEmpty: 'Selecciona productos para agregar al grupo.',
    productsVinculacionHubChannelsMeta: 'Canales: {channels} · {listings} publicaciones agrupadas',
    ...
    productsVinculacionViewByLabel: 'Vista',
    productsVinculacionViewByChannel: 'Canal',
    productsVinculacionViewByProduct: 'Producto',
    productsVinculacionGroupByChannel: 'Agrupar por canal',
    productsVinculacionGroupByChannelHelp:
      'Por defecto las métricas se agrupan por producto. Activa esta opción para verlas por canal.',
    productsVinculacionFilterProductsAll: 'Todos los productos',
    productsVinculacionHeaderProductsLabel: 'Productos',
    productsVinculacionHeaderRelatedHover: 'Ver productos del grupo',
  ...
  en: {
    ...
    permTaxRatesManage: 'Manage tax rates',
    permTaxRatesManageDesc: 'Configure withholding and transferred VAT percentages.',
    permTaxRatesView: 'View tax rates',
    permTaxRatesViewDesc: 'See configured tax percentages for the workspace.',
    ...
    workspaceConfigFxRatesSubtitle:
      'Market rates applied to orders and expenses in currencies other than the workspace base.',
    workspaceConfigFxRatesFiltersTitle: 'Filters',
    workspaceConfigFxRatesListTitle: 'Rate history',
    workspaceConfigFxRatesAutoHint: 'Updated automatically. Read-only in this version.',
    workspaceConfigFxRatesChartTitle: 'Exchange rate trend',
    workspaceConfigFxRatesChartDescription: 'Daily series for {pair} in the selected range.',
    workspaceConfigFxRatesChartEmpty: 'No chart data for the current filters.',
    workspaceConfigFxRatesLoadFailed: 'Could not load exchange rates.',
    workspaceConfigFxRatesEmpty: 'No rates recorded yet.',
    workspaceConfigFxRatesColDate: 'Date',
    workspaceConfigFxRatesColPair: 'Pair',
    workspaceConfigFxRatesColRate: 'Rate',
    workspaceConfigFxRatesColSource: 'Source',
    ...
    settingsCurrencyDescription:
      'Workspace base currency for reports and costs. It cannot be changed after the workspace is created.',
    ...
    salesYoyChartCalcDescription: 'Compares net sales for the current period with the same range a year earlier.',
    salesYoyChartCalcLeft: 'YoY = ',
    salesYoyChartCalcFormula: 'current net sales vs prior year',
    ...
    salesQualityHelpDiscountRate:
      'Share of gross sales given up as discounts in the period. Lower means less list-price erosion.',
    salesQualityHelpDiscountRateCalcLeft: 'Rate = ',
    salesQualityHelpDiscountRateCalcPart: 'discounts ÷ gross sales',
    salesQualityReturnRate: 'Return rate',
    salesQualityHelpReturnRate:
      'Share of gross sales lost to returns and cancellations in the period.',
    salesQualityHelpReturnRateCalcLeft: 'Rate = ',
    salesQualityHelpReturnRateCalcPart: 'returns ÷ gross sales',
    salesQualityUnitsPerOrder: 'Units per order',
    salesQualityHelpUnitsPerOrder:
      'Average number of units included in each order for the period.',
    salesQualityHelpUnitsPerOrderCalcLeft: 'UPO = ',
    salesQualityHelpUnitsPerOrderCalcPart: 'units ÷ orders',
    salesSkuColumn: 'SKU',
    ...
    channelsPnlTitleByProduct: 'P&L by product',
    ...
    channelsPnlSubtitleByProduct:
      'Alenna profitability by product in the group, including orders and AOV.',
    channelsCmChartTitle: 'Contribution margin by channel',
    channelsCmChartSubtitle: 'CM$ over time by platform.',
    channelsCmChartCalcDescription: 'Contribution margin in money by channel over the period.',
    channelsCmChartCalcLeft: 'CM$ = ',
    channelsCmChartCalcFormula: 'net sales − COGS − fees − shipping − ads',
    channelsCostStructureCalcDescription:
      'How each unit of net sales splits across COGS, fees, shipping, and contribution.',
    channelsCostStructureCalcLeft: 'Structure = ',
    channelsCostStructureCalcFormula: '% of net sales by line item',
    ...
    channelsPnlSubtitleProductScope:
      'The last line shows approximate gross profit: platform fees and shipping are not allocated by product.',
    ...
    reportsKpiHelpChannelMargin:
      'Real economics of selling on the channel: what remains of gross profit after fees and shipping.',
    reportsKpiHelpChannelMarginCalcLeft: 'Margin = ',
    reportsKpiHelpChannelMarginCalcPart: 'gross profit − fees − shipping',
    homeKpiRoasGlobal: 'Global ROAS',
    homeKpiRoasGlobalHelp: 'Return on ad spend for the period.',
    homeKpiRoasGlobalCalcLeft: 'ROAS = ',
    homeKpiRoasGlobalCalcPart: 'attributed sales ÷ ad spend',
    ...
    homeAdsTrendCalcDescription: 'Ad spend and attributed sales for the selected period.',
    homeAdsTrendCalcLeft: 'Advertising = ',
    homeAdsTrendCalcPartSpend: 'ad spend',
    homeAdsTrendCalcPartSales: 'attributed sales',
    ...
    homeMetricsTrendCalcDescription: 'Trend of the selected metrics for the filter period.',
    homeMetricsTrendCalcLeft: 'Series = ',
    homeMetricsTrendCalcPartNet: 'net sales',
    homeMetricsTrendCalcPartCm: 'contribution',
    homeMetricsTrendCalcPartUnits: 'units / orders',
    homeMetricsTrendSubtitle:
    ...
    adsKpiHelpRoas: 'Return on ad spend. Empty when spend is 0.',
    adsKpiHelpRoasCalcLeft: 'ROAS = ',
    adsKpiHelpRoasCalcPart: 'attributed sales ÷ spend',
    adsKpiHelpBreakEvenRoas:
      'Minimum ROAS to preserve gross margin. Needs complete COGS on sales; empty when costs are incomplete or margin ≤ 0.',
    adsKpiHelpBreakEvenRoasCalcLeft: 'BE ROAS = ',
    adsKpiHelpBreakEvenRoasCalcPart: '1 ÷ gross margin %',
    adsKpiHelpTacos:
      'Total Advertising Cost of Sales: share of linked-channel net sales spent on ads. Empty when no store is linked (ads-only).',
    adsKpiHelpTacosCalcLeft: 'TACoS = ',
    adsKpiHelpTacosCalcPart: 'ad spend ÷ net sales',
    adsKpiHelpCpa:
      'Cost per acquisition: average ad spend per attributed conversion. Empty when conversions are 0.',
    adsKpiHelpCpaCalcLeft: 'CPA = ',
    adsKpiHelpCpaCalcPart: 'spend ÷ conversions',
    ...
    adsChartTrendCalcDescription: 'Ad spend and attributed sales for the selected period.',
    adsChartTrendCalcLeft: 'Advertising = ',
    adsChartTrendCalcPartSpend: 'ad spend',
    adsChartTrendCalcPartSales: 'attributed sales',
    adsChartChannelCalcDescription: 'Each channel’s share of ad spend for the period.',
    adsChartChannelCalcLeft: 'Share = ',
    adsChartChannelCalcFormula: 'channel spend ÷ total ad spend',
    ...
    adsSyncWaitingAmazonReport: 'Waiting for Amazon Ads report…',
    adsSyncWaitingAmazonReportDetail:
      'Amazon is generating the report ({type}, {start}–{end}). This can take several minutes.',
    adsCampaignTypeSponsoredProducts: 'Sponsored Products',
    adsCampaignTypeSponsoredBrands: 'Sponsored Brands',
    adsCampaignTypeSponsoredDisplay: 'Sponsored Display',
    ...
    homeChannelDonutCalcDescription: 'Each channel’s share of net sales for the period.',
    homeChannelDonutCalcLeft: 'Share = ',
    homeChannelDonutCalcFormula: 'channel net sales ÷ total net sales',
    homeChannelDonutCalcPartNet: 'channel net sales',
    homeChannelDonutCalcPartShare: 'total net sales',
    ...
    homeTopProductsCalcDescription: 'Product ranking by net sales for the period.',
    homeTopProductsCalcLeft: 'Top products = ',
    homeTopProductsCalcPartUnits: 'units sold',
    homeTopProductsCalcPartNet: 'net sales',
    ...
    reportsKpiHelpContributionMargin: 'What remains to cover fixed costs.',
    reportsKpiHelpContributionMarginCalcLeft: 'CM = ',
    reportsKpiHelpContributionMarginCalcPart: 'channel margin − ad spend',
    reportsKpiHelpEbitda:
      'Does not include platform withholdings (those affect liquidity, not profitability).',
    reportsKpiHelpEbitdaCalcLeft: 'EBITDA = ',
    reportsKpiHelpEbitdaCalcPart: 'marginal contribution − fixed operating expenses',
    ...
    settlementWfTotal: 'Total',
    settlementCancelCostTitle: 'Returned charge / Cancellation costs',
    settlementCancelCostHint:
      'MeLi cancellations with residual cost (shipping + return fee). Already in estimated payout; shown here as a breakdown, not under P&L Returns.',
    settlementCancelCostSection: 'Returned charge (MeLi)',
    settlementCancelCostMerchandise: 'Product price',
    settlementCancelCostAnnulled: 'Merchandise annulment',
    settlementCancelCostFees: 'Net marketplace fees',
    settlementCancelCostShipping: 'Shipping / return fee',
    settlementCancelCostTax: 'Net tax withholdings',
    settlementCancelCostTotal: 'Total cost (MeLi net)',
    ...
    reportsWaterfallCalcDescription:
      'P&L breakdown: each bar adds or subtracts from gross sales down to the period result.',
    reportsWaterfallCalcLeft: 'EBITDA ≈ ',
    reportsWaterfallCalcPartGross: 'gross sales',
    reportsWaterfallCalcPartDeductions: '− deductions',
    reportsWaterfallCalcPartCogs: '− COGS',
    reportsWaterfallCalcPartOpex: '− ads and expenses',
    reportsSettlementCalcDescription:
      'Estimated platform payout: gross sales minus discounts, returns, fees, shipping, and withholdings.',
    reportsSettlementCalcLeft: 'Net payout ≈ ',
    reportsSettlementCalcPartGross: 'gross sales',
    reportsSettlementCalcPartDeductions: '− discounts/returns',
    reportsSettlementCalcPartFees: '− fees and charges',
    dashboardProfitMarginCalcDescription:
      'Gross profit for the period and its margin on net sales.',
    dashboardProfitMarginCalcLeft: 'Gross margin % = ',
    dashboardProfitMarginCalcFormula: 'gross profit ÷ net sales',
    ...
    reportsKpiAov: 'AOV',
    reportsKpiHelpAov:
      'Average Order Value: how much revenue each order contributes on average in the period.',
    reportsKpiHelpAovCalcLeft: 'AOV = ',
    reportsKpiHelpAovCalcPart: 'sales ÷ orders',
    reportsKpiMomLabel: 'MoM growth %',
    reportsKpiHelpMom:
      'Month-over-month growth of net sales versus the prior calendar month.',
    reportsKpiHelpMomCalcLeft: 'MoM = ',
    reportsKpiHelpMomCalcPart: '(current − prior month) ÷ prior month',
    reportsKpiYoyLabel: 'YoY growth %',
    reportsKpiHelpYoy:
      'Year-over-year growth of net sales versus the same date range one year ago.',
    reportsKpiHelpYoyCalcLeft: 'YoY = ',
    reportsKpiHelpYoyCalcPart: '(current − prior year) ÷ prior year',
    reportsKpiCogsLabel: 'COGS',
    ...
    reportsTaxBlockWithholdingIsr: 'ISR withholding',
    reportsTaxBlockWithholdingIva: 'VAT withholding',
    ...
    productsDetailTabPlatformPayment: 'Profitability',
    productsDetailTabVariants: 'Variants',
    productsDetailTabCogs: 'COGS',
    productsDetailTabRelated: 'Products',
    productsCatalogTabProducts: 'Products',
    productsCatalogTabGroups: 'Groups',
    productsTableGroupSelected: 'Group',
    productsTableGroupFailed: 'Could not group the selection.',
    productsTableGroupNeedTwo: 'Select at least 2 products to group.',
    productsDetailChannelMargin: 'Channel margin',
    productsDetailChannelMarginHelp:
      'Real economics of selling on the channel: what remains of gross profit after marketplace fees and shipping.',
    productsDetailChannelMarginHelpCalcLeft: 'Margin = ',
    productsDetailChannelMarginHelpCalcPart: 'gross profit − fees − shipping',
    productsDetailCmPerUnit: 'CM / unit',
    productsDetailAvgPrice: 'Avg. price',
    productsDetailUnitCogs: 'Unit COGS',
    productsDetailAdsAssigned: 'Assigned ads',
    productsDetailChannelPnlTitle: 'P&L by channel',
    productsDetailInventoryByChannelTitle: 'Inventory by channel',
    ...
    productsVinculacionKindLinked: 'Linked',
    productsVinculacionColMatchType: 'Match type',
    ...
    productsVinculacionPickerSelectedEmpty: 'Select products to link (multiple from the same channel are allowed).',
    ...
    productsVinculacionDangerSubtitle:
      'Permanent actions on this link group. They cannot be undone.',
    productsVinculacionDangerCardTitle: 'Delete group',
    productsVinculacionDangerDescription:
    ...
    productsVinculacionRename: 'Rename',
    productsVinculacionMoreActions: 'More actions',
    productsVinculacionPickerAddTitle: 'Add to group',
    productsVinculacionPickerAddEmpty: 'Select products to add to the group.',
    productsVinculacionHubChannelsMeta: 'Channels: {channels} · {listings} grouped listings',
    ...
    productsVinculacionViewByLabel: 'View',
    productsVinculacionViewByChannel: 'Channel',
    productsVinculacionViewByProduct: 'Product',
    productsVinculacionGroupByChannel: 'Group by channel',
    productsVinculacionGroupByChannelHelp:
      'Metrics are grouped by product by default. Turn this on to view them by channel.',
    productsVinculacionFilterProductsAll: 'All products',
    productsVinculacionHeaderProductsLabel: 'Products',
    productsVinculacionHeaderRelatedHover: 'View products in this group',
