const SHELL_STRINGS = {
  es: {
    ...
    teamRolesWizardNameHint: 'Así aparecerá el rol al asignar miembros.',
    teamRolesWizardPermissionsHint: 'Elige qué puede hacer este rol en el espacio de trabajo.',
    teamRolesWizardUsersHint: 'Opcional. Asigna miembros existentes a este rol.',
    teamRolesWizardUsersEmpty: 'No hay miembros que puedas asignar a este rol.',
    teamRolesWizardConfirmHint: 'Revisa el nombre, los permisos y a quién se asignará el rol.',
  ...
  en: {
    ...
    teamRolesWizardNameHint: 'This is how the role will appear when assigning members.',
    teamRolesWizardPermissionsHint: 'Choose what this role can do in the workspace.',
    teamRolesWizardUsersHint: 'Optional. Assign existing members to this role.',
    teamRolesWizardUsersEmpty: 'There are no members you can assign to this role.',
    teamRolesWizardConfirmHint: 'Review the name, permissions, and who will be assigned this role.',
