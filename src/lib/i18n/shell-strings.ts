const SHELL_STRINGS = {
  es: {
    ...
    teamInviteSheetDescription:
      'Envía una invitación y elige el acceso que tendrá la nueva persona en tu workspace.',
    ...
    teamErrorAlreadyMember: 'Esta persona ya es miembro del workspace.',
    ...
    teamErrorLastOwner: 'Debe quedar al menos un owner en el workspace.',
    ...
    teamRolesSectionTitle: 'Roles del workspace',
    ...
    teamRolesWizardPermissionsHint: 'Elige qué puede hacer este rol en el workspace.',
    ...
    permTeamViewDesc: 'Ver la lista de miembros y los roles del workspace.',
    ...
    permFxManageDesc: 'Actualizar los tipos de cambio del workspace.',
    ...
    permExpensesDeleteDesc: 'Eliminar gastos del workspace.',
    permAdsView: 'Ver ads',
    ...
    permWorkspaceConfigViewDesc: 'Ver ajustes generales del workspace.',
    ...
    billingUsersLimitDescription: 'Usuarios activos e invitaciones pendientes en tu workspace.',
    ...
    integrationAdsSyncDescription: 'Trae gasto, clics y ventas atribuidas de los últimos 90 días en la primera sync.',
