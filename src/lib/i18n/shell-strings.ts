const SHELL_STRINGS = {
  es: {
    ...
    productsDetailEditSellingPrice: 'Precio de venta (canal)',
    productsDetailEditSellingPriceHint:
      'El precio mostrado es el de la publicación principal; la tienda es la fuente de verdad.',
    productsDetailRecalcCogsCheckbox: 'Recalcular COGS histórico para el rango',
  ...
  en: {
    ...
    productsDetailEditSellingPrice: 'Selling price (channel)',
    productsDetailEditSellingPriceHint:
      'Shown price is from the primary listing; your store remains the source of truth.',
    productsDetailRecalcCogsCheckbox: 'Recalculate historical COGS for the range',
