const SHELL_STRINGS = {
  es: {
    ...
    navAlarms: 'Alarmas',
    alarmsListSubtitle: 'Elige un tipo de alarma para configurar sus reglas.',
    alarmsStockTypeTitle: 'Stock',
    alarmsStockTypeDescription: 'Stock bajo configurable y sin stock siempre activo cuando el inventario llega a cero.',
    alarmsHeroTitle: 'Alarmas',
    alarmsHeroSubtitle: 'Configura umbrales de stock bajo por workspace, canal, producto o listing.',
    alarmsOpenActiveAlerts: 'Ver alertas activas',
    alarmsStockSectionTitle: 'Alertas de stock',
    alarmsOutOfStockTitle: 'Sin stock',
    alarmsOutOfStockDescription: 'Siempre activa cuando el inventario llega a cero.',
    alarmsOutOfStockNote: 'Las alertas críticas de sin stock no se pueden desactivar.',
    ...
    alarmsLowStockEnabledHelp: 'Desactivar resuelve alertas low existentes en el alcance.',
    ...
    alarmsScopedRulesDescription: 'Sobrescribe el predeterminado para un canal, producto o listing.',
    ...
    alarmsOverrideSheetDescription: 'Las reglas más específicas tienen prioridad sobre las generales.',
  ...
  en: {
    ...
    navAlarms: 'Alarms',
    alarmsListSubtitle: 'Choose an alarm type to configure its rules.',
    alarmsStockTypeTitle: 'Stock',
    alarmsStockTypeDescription: 'Configurable low stock and always-on out of stock when inventory reaches zero.',
    alarmsHeroTitle: 'Alarms',
    alarmsHeroSubtitle: 'Configure low-stock thresholds at workspace, channel, product, or listing level.',
    alarmsOpenActiveAlerts: 'View active alerts',
    alarmsStockSectionTitle: 'Stock alerts',
    alarmsOutOfStockTitle: 'Out of stock',
    alarmsOutOfStockDescription: 'Always on when inventory reaches zero.',
    alarmsOutOfStockNote: 'Critical out-of-stock alerts cannot be disabled.',
    ...
    alarmsSaving: 'Saving…',
    alarmsAdminOnly: 'Only admins can edit alarm configuration.',
    alarmsScopedRulesTitle: 'Scoped rules',
    alarmsScopedRulesDescription: 'Override the default for a channel, product, or listing.',
    ...
    alarmsOverrideSheetDescription: 'More specific rules take precedence over broader ones.',
