const SHELL_STRINGS = {
  es: {
    ...
    alarmsLowStockEnabledHelp: 'Desactivar resuelve alertas de stock bajo existentes en el alcance.',
  ...
  en: {
    ...
    alarmsLowStockEnabledHelp: 'Disabling resolves existing low-severity alerts in scope.',
