const SHELL_STRINGS = {
  es: {
    ...
    integrationConsentTitle: 'Datos que vamos a solicitar',
    integrationConsentBody:
      'Alenna pedirá acceso de solo lectura a estos datos para calcular tus métricas. No hay casillas que desmarcar: conecta o cancela.',
  ...
  en: {
    ...
    integrationConsentTitle: 'Data we will request',
    integrationConsentBody:
      'Alenna will request read-only access to this data to compute your metrics. There are no permission checkboxes: continue or cancel.',
