  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed z-50 flex min-h-0 w-full max-w-md flex-col gap-0 overflow-hidden border border-border-subtle bg-background p-0 text-sm shadow-2xl ring-1 ring-foreground/5 duration-200 outline-none data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0",
          side === "right" &&
