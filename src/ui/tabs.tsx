...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default:
          "border border-white/35 bg-white/[0.28] backdrop-blur-md shadow-[inset_0_1px_0_rgba(255,255,255,0.25)]",
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "data-active:border-white/50 data-active:bg-white/[0.45] data-active:text-foreground data-active:shadow-[inset_0_1px_0_rgba(255,255,255,0.35)]",
